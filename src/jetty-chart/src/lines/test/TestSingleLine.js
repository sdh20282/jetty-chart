    ...
    <div style={{ display: "flex", flexWrap: "wrap", width: "1600px" }}>
      ...
      <SingleLine
        ...
        normalSettings={{
          ...
          colorPalette: ["#3772FF", "#ff8000", "#2A9D8F", "#D7BDE2"],
          padding: 0,
          reverse: false,
          horizontal: false,
        }}
      ...
      <SingleLine
        ...
        normalSettings={{
          ...
          margin: { top: 60, bottom: 70, left: 80, right: 100 },
          innerMargin: { top: 0, bottom: 0 },
          colorPalette: ["#ff8000", "#2A9D8F", "#D7BDE2"],
          padding: 0,
          reverse: false,
          horizontal: false,
        }}
        ...
        animationSettings={{
          ...
          pointSettings: {
            ...
            pointRenderType: "draw",
            pointRenderDuration: 1,
            pointLineRenderDuration: 0.8,
            pointRenderStartDelay: 0.1,
            pointRenderItemDelay: 0,
            pointRenderTimingFunction: "ease",

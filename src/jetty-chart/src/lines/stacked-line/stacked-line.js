...
const StackedLine = ({
  ...
  return (
    <MultiLine
      ...
      leftLegendSettings={result.leftLabelSettings}
      rightLegendSettings={result.rightLabelSettings}
  ...
  //       return (
  //         <g key={`point-${ms}-${index}`} transform={horizontal ? `translate(0,${padding})` : `translate(${padding})`}>
  //           {data.map((d, idx) => {
  //             return (
  //               <g
  //                 key={"point-stacked-" + idx}
